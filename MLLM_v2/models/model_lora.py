...
from modules.transformer_lora import (
    LoRAStreamingTransformer,
    create_norm_fn,
)
...
class LMModel(StreamingContainer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.transformer = LoRAStreamingTransformer(
            d_model=dim,
            num_heads=num_heads,
        ...
        self.depformer = LoRAStreamingTransformer(
    ...
    def forward(self, sequence: torch.Tensor, masks: torch.Tensor = None):
        ...
        global_input_sequence = torch.cat([global_start_frame, sequence[:,:,:-1]], dim=2) 
        ...
        # text_indices = rearrange((text_logits.reshape(-1, text_logits.shape[-1])).max(1)[1], "(b t) -> b t", b=B)
        ...
        local_sequence = global_input_sequence[:,1:self.dep_q+1,:] # B, 8, T
    ...
    def forward_text(
        ...
        input_ = None
        #print('self.num_audio_codebooks ', self.num_audio_codebooks)
